...
export function BlogPost() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to="/" className="text-sm underline text-blue-600">Back to Blog</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Nav */}
      <nav className="border-b border-gray-200 sticky top-0 z-20 bg-white/95 backdrop-blur-sm">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center justify-between h-14">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-[15px]">Rakshna Mait</span>
            </Link>
            <div className="flex items-center gap-6 text-sm text-gray-600">
              <a href="https://www.rakshnamait.com" className="hover:text-gray-900 transition-colors hidden sm:block">Home</a>
              <Link to="/" className="text-gray-900">Blog</Link>
              <a href="https://www.rakshnamait.com" className="hover:text-gray-900 transition-colors hidden sm:block">About</a>
            </div>
          </div>
        </div>
      </nav>
      ...
      >
        <button onClick={() => navigate(-1)} className="inline-flex items-center gap-1 hover:text-gray-900 transition-colors">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">Rakshna Mait</span>
            </div>
            <p className="text-xs text-gray-400">© 2026 Rakshna Mait. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
